...
class MySlave(Slave):
    ...
    def do_work(self, data):
        ...
        weight = density_elg_like/density_sim
        ...
        table_final.write(topdir + 'kde_outputs2/sim_kde_weighed_chunk21_part_'+str(task_arg)+'.fits',overwrite=True)
...
fn_sim_contamination = topdir+'sgc_run_sim_really_masked_chunk21_contamination.fits'
