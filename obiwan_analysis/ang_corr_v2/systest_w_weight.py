...
def Obiwansys(surveyname,map_name='ext',sysmax=0.13,sysmin=0.01,res=256,nest = False,dataset = 'obiwan',xlab = ''):
    ...
    outputname = './data/'+dirs.name+'_'+map_name+'_sys_'+dataset+'.dat'
    print("test1")
    #file readin
...
name = 'ELG_clustering_v4_chunk21'
Type = 'uniform'
...
Obiwansys(eboss,'hpstardens',sysmax=1500,sysmin=1100,dataset = 'uniform',xlab='star')
Obiwansys(eboss,'hpstardens',sysmax=1500,sysmin=1100,dataset = 'weight',xlab='star')
