...
srun -N 20 -n 1280 -c 1 python3 example1.py eBOSS_ELG_clustering_eboss23_v5.dat_obiwan_weight_subset eBOSS_ELG_clustering_eboss23_v5.ran_obiwan_weight_subset elg_ngc_run_conbimed_uniform
