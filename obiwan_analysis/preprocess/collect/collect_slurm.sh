...
tot_counter=1 #this is consistent with # of Nodes(-N) requested
name_for_run=chunk21_10deg2_test
chunk=chunk21

while [ $counter -lt $tot_counter ]
do
    srun -N 1 -n 8 -c 8 python collect_mpi.py --name_for_run ${name_for_run} --split_idx $counter --N_split $tot_counter --region sgc --n_obj 100 --start_id 0 --rs_type more_rs0 --name_for_randoms sgc_brick_dat_2 &
