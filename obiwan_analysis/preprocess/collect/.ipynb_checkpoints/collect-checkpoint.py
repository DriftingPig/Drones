...
def ELG_selection_for_dr3(brickname):
    tractor = os.path.join(dr3_tractor_dir,,brickname[:3],'tractor-'+brickname+'.fits')
    noJunk = (tractor['brick_primary'])&(tractor['decam_anymask'][1])&(tractor['decam_anymask'][2])&(tractor['decam_anymask'][4])&(tractor['tycho2inblob']==False)
    ...
    # the color color selection
    g     = 22.5 - 2.5 * n.log10(dat['decam_flux'][1] / dat['decam_mw_transmission'][1])
    r_mag = 22.5 - 2.5 * n.log10(dat['decam_flux'][2] / dat['decam_mw_transmission'][2])
    z_mag = 22.5 - 2.5 * n.log10(dat['decam_flux'][4] / dat['decam_mw_transmission'][4])
    gr = g - r_mag
    rz = r_mag - z_mag
    color_sgc = (g>21.825)&(g<22.825)&(-0.068*rz+0.457<gr)&(gr< 0.112*rz+0.773) &(0.218*gr+0.571<rz)&(rz<-0.555*gr+1.901)
    color_ngc = (g>21.825)&(g<22.9)  &(-0.068*rz+0.457<gr)&(gr< 0.112*rz+0.773) &(0.637*gr+0.399<rz)&(rz<-0.555*gr+1.901)
