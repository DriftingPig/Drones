...
class MyApp(object):
    ...
    def run(self, tasks=None):
        ...
        bricknames.sort()
        bricknames = bricknames[6000:8000]
        ...
        final_table.write(os.path.join(os.environ['obiwan_out'],'subset','dr3_elg_like_part4.fits'), format='fits',overwrite=True)
        print('done!')
...
class MySlave(Slave):
    ...
    def do_work(self, data):
        ...
        flag, tab= ELG_like_selection_for_dr3(task_arg,region='sgc')  
