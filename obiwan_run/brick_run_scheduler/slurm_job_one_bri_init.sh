#!/bin/bash -l
#RANDOMS_FROM_FITS=/global/cscratch1/sd/huikong/obiwan_Aug/repos_for_docker/obiwan_out/eboss_elg/ngc_brick_dat/brick_${1}.fits
RANDOMS_FROM_FITS=/global/cscratch1/sd/huikong/obiwan_Aug/repos_for_docker/obiwan_out/eboss_elg/$random_name/brick_${1}.fits
bri=$(echo ${1} | head -c 3)
...
python $obiwan_code/py/obiwan/kenobi.py --dataset ${dataset} -b $1 \
       ...
       --verbose \
       --survey_dir /global/cscratch1/sd/huikong/obiwan_Aug/repos_for_docker/obiwan_data/new_calibs/DR3_copies${3}/legacysurveydir_dr3_copy${2} \
       >> $log 2>&1
