...
python $obiwan_code/py/obiwan/kenobi.py --dataset ${dataset} -b $1 \
       ...
       --verbose \
       --survey_dir /global/cscratch1/sd/huikong/obiwan_Aug/repos_for_docker/obiwan_data/new_calibs/DR3_copies0/legacysurveydir_dr3_copy1/  #legacysurveydir_debug_run #legacysurveydir_dr3/
